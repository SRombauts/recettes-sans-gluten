...
- La **barre latérale** (à gauche sur grand écran, en haut sur mobile) liste
  toutes les sections et recettes.
- La **recherche** (en haut) permet de retrouver un ingrédient ou une recette
  en quelques lettres.
...
[Gâteau au chocolat sans gluten à la compote]({{ '/Patisserie/GateauChocolatCompoteSansBeurre' | relative_url }}) — moelleux, sans beurre ni sucre raffiné, parsemé d'amandes concassées :
