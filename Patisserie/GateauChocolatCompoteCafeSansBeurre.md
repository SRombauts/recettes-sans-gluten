...
*   4 g café soluble (1 cuillère à café bombée — augmenter à 7-8 g pour un goût café marqué)
* 140 g [mélange de farines patisserie](MixFarinesPatisserie.md)
*   4 oeufs
*   1/2 sachet levure chimique
*   1 sachet sucre vanillé (optionnel, complète le chocolat)
*   2 g de sel
...
La cannelle de la recette de base est retirée : elle entre en conflit aromatique
avec le café. La pomme reste présente mais en arrière-plan.

# Préparation

1. Préchauffer le four à 170°C.
2. Mettre la compote dans un bol, ajouter le café soluble et bien remuer pour
   le dissoudre (la compote froide suffit ; à défaut, écraser les grumeaux à la
   spatule).
3. Casser le chocolat en morceaux dans le bol sur la compote au café, et faire
   ...
   Laisser tiédir.
4. Incorporer les oeufs à la base chocolat-café tiédie.
5. Ajouter les ingrédients secs progressivement : farine, sucre vanillé, sel,
   amandes en poudre, en terminant par la levure chimique.
...
[version sans café](GateauChocolatCompoteSansBeurre.md).

# Notes

* Dissoudre le café dans la compote *avant* de chauffer le chocolat évite les
  grains non dissous dans la pâte cuite. La compote est suffisamment humide,
  même froide, pour solubiliser le café.
* Doses repères :
...
* Compatible avec la [version protéinée](GateauChocolatCompoteProteineSansBeurre.md) :
